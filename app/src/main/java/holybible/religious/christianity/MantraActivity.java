...
public class MantraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //navMenuTitles = getResources().getStringArray(R.array.aarti_array);

        //Maan Ki Baat Hai Bhaii......
        ...
        navDrawerItems = dbHelper.getprayerdata();
    ...
    private void selectItem(int position) {
        ...
        Fragment fragment = new mantrafragment();
        Bundle args = new Bundle();
        //	args.putString(mantrafragment.ARG_PLANET_NUMBER, getResources().getString(mChalisa[position]));
